...
<div class="container-fluid" >
	<div class="grp" style="background-color:#d6e5ff;width: 60% ;margin:auto;padding:20px 5px 20px 5px; border-radius:20px;min-width:275px">
		...
		<div class="dashboard">
			<a href='viewrequest.php'><button type="button" class="btn" style="width:50%;min-width:175px;padding:2px 2px 2px 2px;"><span class="dashboard1">View Order</span></button></a>
		</div>
		<div class="dashboard">
