...
{
		$checkquery="SELECT username FROM restaurant WHERE username='$username' AND email='$email' AND mobileno='$mobile'";	
}
...
if($stmt->num_rows > 0)
{
	...
	{
			$updatequery="UPDATE restaurant SET password='$password' WHERE username='$username'";	
	}
