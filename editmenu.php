...
<div class="container-fluid" style="background-color:#ffb25b ;padding:0px 0px 50px 0px;">
	...
	<div class="col-sm-4">
		<div class="sbox">
			<button type="submit" class="btn" value="edit" style="width:30%;min-width:100px !important;" >Remove</button>  <button type="reset"   class="btn" value="remove" style="width:30%;min-width:100px !important;" >Reset</button>
		</div>
	</div>
	...
	if($i==False)
	echo"<center><b><br><br><br><h3 style='color:red;'>No Dish Found.<br>Please try again later.</h3></center>";
	if($print=='True')
	{
		echo"<center><b><br><h3 style='color:red;'>Dish Removed Successfully<br>Menu is Updated !!</h3></center>";
		$_SESSION['show']='False';
	}
