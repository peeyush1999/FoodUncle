...
$updatequery="UPDATE restaurant SET email='$email', mobileno='$mobile',address='$address',city='$city',state='$state' WHERE username='$username'";
...
<div class="container">
	<br>
	<p style="font-size:1.5em;color:black" align="center">Employee  !!  You have successfully updated your Profile<br>
	<br>
