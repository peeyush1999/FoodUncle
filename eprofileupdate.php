...
$query="SELECT username,name,mobileno,address,email,city,state,timing FROM restaurant where username='$username'";
$stmt=$conn->prepare($query);
$stmt->execute();

$stmt->bind_result($uname,$name,$mobile,$address,$email,$city,$state,$timing);
$stmt->fetch();
?>
	...
	<div class='row' style="min-width:600px;">
		<form class='update-profile' id='update-profile' action='updateevalidate.php' onsubmit='return employee_update_validate();' method='post'>
			<div class='form-group' >
				<label style='font-size:1.5em ;top-padding:20px;'><b>Update Employee Profile</b></label>				
			</div>
			...
			<div class='form-group1' >
				 ...
				 <input type='text' placeholder='Update Your Experience' name='timing' class='exp form-control' <?php echo 'value="'.$timing.'"' ?> required > 
			</div>
			<div class='form-group1' >
