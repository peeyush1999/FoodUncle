...
<!-- ==============================================================================================================================================================================-->
					...
					<div class="col-sm-6" >
					<img src="assets/img/chef1.png" alt="employee" height="48%" width="48%"><br><BR>
					<a class="btn1 launch-modal" href="#" data-modal-id="modal-register-employee" ><button class="btn" style="width:30%"><span id="choice">Restaurant</span></button> </a>
					</div>
		...
		<form class="e-registration-form" id="register1" action="eregistervalidate.php" onsubmit="return employee_reg_validate();" method="post" >
					...
					<div class="form-group">
						 ...
						 <input type="text" placeholder="Timings (9:00 AM - 10:00PM)" name="timing" class="form-first-name form-control" required> 
					</div>
					<div class="form-group">
						 <label><b>Email</b></label> 
						 <input type="text" placeholder="Enter Your Email" name="email" class="form-first-name form-control"  required> 
